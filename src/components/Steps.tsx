...
const steps: Step[] = [
  {
    ...
    description: (
      <>
        &nbsp;
        <a href="https://dc.pipvaro.com" target="_blank" rel="noopener noreferrer" className="underline decoration-white/30 underline-offset-4 hover:decoration-white">
          Sign Up
        </a>
...
export function Steps() {
  return (
    <section id="steps" className="pt-14 pb-20 sm:pt-16 sm:pb-24">
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          <h2 className="text-3xl font-bold tracking-tight text-white sm:text-4xl">How it works</h2>
          <p className="mt-3 text-white/60">A quick overview of getting started.</p>
        </div>
        ...
        <div className="relative mt-8 lg:mt-10">
          ...
          <ul role="list" className="grid grid-cols-1 gap-10 lg:grid-cols-5">
            {steps.map((step, i) => (
              <li key={i} className="relative flex items-start gap-4 lg:flex-col lg:items-center lg:text-center">
                <div className="relative z-10 flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#3f4bf2] font-semibold text-white ring-4 ring-white/5 shadow-md lg:mb-4">{i + 1}</div>
