      ...
      <section className="relative isolate bg-gradient-to-b from-[#3f4bf2]/20 via-transparent to-transparent">
        <div className="mx-auto max-w-5xl px-6 pt-16 pb-10">
          ...
          <p className="mt-3 max-w-3xl text-white/70">
            ...
            you use <span className="text-white">pipvaro.com</span> and our
            apps. We comply with GDPR/UK GDPR and provide CPRA disclosures for
      ...
      <main className="mx-auto grid max-w-5xl grid-cols-1 gap-10 px-6 pb-20 md:grid-cols-[220px_1fr]">
        ...
        <article className="space-y-10 leading-relaxed text-white/80">
          <section id="controller" className="scroll-mt-24">
            ...
            <p>
              <span className="text-white">[Company name/legal entity], [address]</span>. 
              Contact our privacy team at{' '}
              <a href="mailto:privacy@pipvaro.com" className={link}>
                privacy@pipvaro.com
              </a>
              . If appointed, our Data Protection Officer (DPO) can be reached at
              the same address.
            </p>
          </section>
          ...
          <section id="collect" className="scroll-mt-24">
            ...
            <ul className="mt-2 list-inside list-disc space-y-1">
              <li>
                Usage & device data: IP, timestamps, pages/actions, app logs, crash
                diagnostics, cookies/local storage IDs.
              </li>
              <li>
              ...
              <li className="text-white/90">
                ...
                servers. On Fusion (self-hosted) it stays on your device/VPS. On
                Lunar/Nova, it is stored on your dedicated VPS under your control.
              </li>
            </ul>
            <h3 className="mt-4 font-medium text-white">From third parties</h3>
            <p className="mt-2">
              Payment status from Stripe; authentication/hosting/analytics info from providers
              such as Vercel, MongoDB Atlas, Cloudflare, SendGrid/email provider, and
              VPS providers we use to provision hosting.
            </p>
          </section>
          ...
          <section id="cookies" className="scroll-mt-24">
            ...
            <p>
              ...
              cookies. Where required, we ask for consent via banner. You can withdraw consent
              in settings; browser controls may also limit cookies.
            </p>
          </section>
          ...
          <section id="sharing" className="scroll-mt-24">
            ...
            <ul className="mt-2 list-inside list-disc space-y-1">
              <li>
                Processors acting on our instructions (hosting, analytics, support, email,
                VPS providers, payment processors).
              </li>
              <li>Compliance & legal recipients when required by law or to protect rights/safety.</li>
            </ul>
            <p className="mt-2">We do <span className="font-semibold text-white">not</span> sell personal information.</p>
          </section>
          ...
          <section id="rights" className="scroll-mt-24">
            ...
            <p>
              You can request access, rectification, erasure, restriction, portability, and
              object to processing based on legitimate interests. Where processing relies on
          ...
          <section id="ccpa" className="scroll-mt-24">
            ...
            <p>
              ...
              California residents may request access, deletion and correction by contacting
              us. Authorized agents may act on your behalf with verifiable proof. We will
              not discriminate for exercising rights.
            </p>
          </section>
          ...
          <section id="security" className="scroll-mt-24">
            ...
            <p>
              We use encryption in transit, access controls, and segregated environments.
              On Fusion, credentials stay on your machine/VPS. On hosted plans, your VPS is
              dedicated to your account—keep access restricted. No system is perfectly
              secure; report issues to{' '}
              <a href="mailto:security@pipvaro.com" className={link}>
                security@pipvaro.com
              </a>
              .
            </p>
          </section>
          ...
          <section id="automation" className="scroll-mt-24">
            ...
            <p>
              We do not use your personal data to make decisions that produce legal or
              similarly significant effects. Trading bots execute strategies you configure
              and are not based on your personal characteristics.
            </p>
          </section>
          ...
          <section id="changes" className="scroll-mt-24">
            ...
            <p>
              ...
              notify you (e.g., in-app or email). Continued use after the effective date
          ...
          <div className="pt-6">
            <a href="#top" className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/5 px-3 py-1.5 text-sm text-white/80 hover:bg-white/10">
              ↑ Back to top
            </a>
          </div>
        </article>
